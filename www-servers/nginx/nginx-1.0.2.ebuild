...
SRC_URI="http://sysoev.ru/nginx/${P}.tar.gz
	...
	nginx_modules_http_accept_language? ( https://download.github.com/giom-nginx_accept_language_module-02262ce.tar.gz )"
...
http_upload http_ey_balancer http_slowfs_cache http_accept_language"
...
src_configure() {
	...
	if use nginx_modules_http_accept_language; then
	  http_enabled=1
	  myconf="${myconf} --add-module=${WORKDIR}/giom-nginx_accept_language_module-02262ce"
	fi
