...
SRC_URI="
  amd64? ( https://dl.google.com/linux/direct/google-webdesigner_current_x86_64.rpm -> ${P}-x86_64.rpm
...
src_install(){
 ...
 ln -svf /lib/libudev.so.1 ${D}/opt/google/webdesigner/libudev.so.0
 ln -svf /opt/google/chrome/google-chrome ${D}/usr/bin/google-chrome
}
